...
// Heading
$_['heading_name'] = 'FindIQ Integration';
$_['heading_title'] = '
    <span style="background: #fff; padding: 4px 0 4px 10px;border-radius: 4px;">
    <span style="color:#ff0000;text-shadow: none;font-weight: 500;">FindIQ</span>
...
$_['entry_imagick_status'] = 'Використовувати  Image  Magick  для генерації ресайзів';
$_['text_token'] = 'Токен';
...
$_['text_resize_width'] = 'Ширина у пікселях для ресайзу зображення';
$_['text_resize_width_placeholder'] = 'px';
$_['text_resize_height'] = 'Висота у пікселях для ресайзу зображення';
$_['text_resize_height_placeholder'] = 'px';
