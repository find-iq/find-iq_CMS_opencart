    ...
    public function install()
    {
        ...
        $this->db->query(
            ...
            (
                ...
                first_synced int unsigned            null,
        ...
        // Migration for existing installs: add first_synced if missing
        $this->db->query('
            ALTER TABLE ' . DB_PREFIX . 'find_iq_sync_products
            ADD COLUMN IF NOT EXISTS first_synced int(10) unsigned DEFAULT NULL
        ');
